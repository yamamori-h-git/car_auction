...
<body>
    ...
    <main>
        ...
        <form action="../../public/auction/member_register.php" method="post">
            <table id="register_form">
                ...
                <tr class="date_form form">
                    ...
                    <td class="tb_right">
                        ...
                        <!-- エラー文はここで表示非表示を切り替える -->
                        <p class="error"><?php echo isset($err['date']) ? $err['date'] : ''; ?></p>
                    </td>
                </tr>
                ...
                <tr class="text_form form post_code">
                    ...
                    <td class="tb_right">
                        ...
                        <!-- エラー文はここで表示非表示を切り替える -->
                        <p class="error"><?php echo isset($err['zip']) ? $err['zip'] : ''; ?></p>
                    </td>
                </tr>
                <tr class="text_form form">
                    <td class="tb_left">
                    ...
                    <td class="tb_right">
                        ...
                        <!-- エラー文はここで表示非表示を切り替える -->
                        <p class="error"><?php echo isset($err['address']) ? $err['address'] : ''; ?></p>
                    </td>
                </tr>
                <tr class="text_form form">
                    <td class="tb_left">
                    ...
                    <td class="tb_right">
                        ...
                        <!-- エラー文はここで表示非表示を切り替える -->
                        <p class="error"><?php echo isset($err['address2']) ? $err['address2'] : ''; ?></p>
                    </td>
                </tr>
                <tr class="text_form form">
                    <td class="tb_left">
                ...
                <tr class="text_form form">
                    ...
                    <td class="tb_right">
                        ...
                        <!-- エラー文はここで表示非表示を切り替える -->
                        <p class="error"><?php echo isset($err['loginid']) ? $err['loginid'] : ''; ?></p>
                    </td>
                </tr>
                <tr class="text_form form">
                    <td class="tb_left">
                    ...
                    <td class="tb_right">
                        ...
                        <!-- エラー文はここで表示非表示を切り替える -->
                        <p class="error"><?php echo isset($err['mail']) ? $err['mail'] : ''; ?></p>
                    </td>
                </tr>
                <tr class="text_form form">
                    <td class="tb_left">
                    ...
                    <td class="tb_right">
                        ...
                        <!-- エラー文はここで表示非表示を切り替える -->
                        <p class="error"><?php echo isset($err['pass']) ? $err['pass'] : ''; ?></p>
                    </td>
                </tr>
            </table>
            <input id="submit" type="submit" name="btn" value="確認画面へ移る">
        </form>
    </main>
    <footer>
        <p><img id="logo" src="../../public/auction/img/logo/logo.png" alt=""></p>
    ...
    <script src="../../public/auction/js/postAddress.js"></script>
</body>
